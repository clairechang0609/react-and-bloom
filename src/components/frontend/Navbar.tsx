...
const Navbar = forwardRef<HTMLDivElement>((_props, ref) => {
  ...
  return (
    <Nav ref={ref} className="py-3 px-5 fixed-top d-flex align-items-center">
      <NavLink to="/" className="d-flex align-items-center px-4" data-scroll data-scroll-direction="horizontal" data-scroll-speed="-4" data-scroll-position="top">
        <Heading>&<em>Bloom</em></Heading>
      </NavLink>
      <div className="d-flex align-items-center ms-auto" data-scroll data-scroll-direction="horizontal" data-scroll-speed="4" data-scroll-position="top">
